...
FIXED: Remove problematic endpoint #7 (uploadFile) that causes Gemini API errors
...
AUTHOR: chaos-playbook-engine Phase 3 (ADK API v5 Fix)
DATE: 2025-11-26
"""
...
def _download_and_cache_swagger(url: str, local_path: str) -> str:
    ...
    # (Don't use cache to avoid stale problematic specs)
    ...
    try:
        ...
        print(f"   🧹 Removing problematic endpoints...")
        ...
        print(f"   ✅ Cleaned OpenAPI spec ready")
