...
FIXED: Updated to use runner.run_debug() API (InMemoryRunner simplified interface)
...
AUTHOR: chaos-playbook-engine Phase 3 (ADK API v2 Fix)
DATE: 2025-11-26
"""
...
def _initialize_chaos_agent() -> tuple[LlmAgent, InMemoryRunner]:
    ...
    # Create OpenAPIToolset from OpenAPI 3.0 JSON STRING
    try:
        petstore_toolset = OpenAPIToolset(
            spec_str=openapi_json_str,  # ← STRING, OpenAPI 3.0 JSON
...
"""
    ...
    # ✅ InMemoryRunner usa InMemorySessionService automáticamente
...
Call the tool now."""
    ...
    # ✅ FIX: InMemoryRunner usa run_debug() que es síncrono y simplificado
    try:
