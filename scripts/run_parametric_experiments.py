...
from core.logging_setup import setup_logger  # ✅ NEW
from experiments.parametric_ab_test_runner import ParametricABTestRunner
...
# 1. PREPARAR DIRECTORIO
    ...
    runner = ParametricABTestRunner(
        ...
        logger=logger  # ✅ Pasar el logger al runner
    )
